...
export const capabilities: Capability[] = [
  ...
  {
    id: "procurement.plan.create",
    name: { en: "Create procurement plan", zh: "生成采购计划" },
    description: {
      en: "Turn consolidated demand into a time-phased, executable procurement plan.",
      zh: "将归集后的需求转化为分期、可执行的采购计划。",
    },
    scenarioIds: ["PR-02"],
    binding: {
      status: "partial",
      erpEndpoint: "metaERP /procurement/purchasingPlan:create",
      note: {
        en: "Standard planning covers time-phasing, but the client's batch calendar (annual for primary equipment, quarterly for secondary) is a category rule the ontology must supply.",
        zh: "标准计划功能支持分期，但客户的批次日历（一次设备年度、二次设备季度）属品类规则，须由本体提供。",
      },
    },
    openQuestionIds: [],
    citations: [{ sourceId: "SRC-06", page: 1, locator: "sheet 1" }],
...
export const baseline: Baseline = {
  ...
  gates: [
    ...
    },
    {
      ...
      status: "fail",
      actual: { en: "1 open, 1 needs clarification", zh: "1 项未裁定、1 项需澄清" },
      threshold: { en: "0 open", zh: "0 项未裁定" },
    ...
    },
    {
      ...
      status: "fail",
      actual: { en: "PR-12 at 41%, PR-06 at 54%", zh: "PR-12 为 41%，PR-06 为 54%" },
      threshold: { en: "≥70% each", zh: "各场景 ≥70%" },
    ...
    },
    {
      ...
      status: "fail",
      actual: { en: "4 pages unreadable", zh: "4 页无法识别" },
      threshold: { en: "0", zh: "0" },
    ...
    },
    {
      ...
      status: "warn",
      actual: { en: "1 gap, 1 manual-today", zh: "1 项缺口、1 项目前人工" },
      threshold: { en: "0 undecided", zh: "0 项未决" },
    ...
    },
    {
      ...
      status: "pass",
      actual: { en: "100%", zh: "100%" },
      threshold: { en: "100%", zh: "100%" },
      offenders: [],
    },
    {
      id: "G-7",
